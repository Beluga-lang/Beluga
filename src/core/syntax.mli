...
(* not sure how to parse "=" in: let x=e in e[x], and "=>" in: lanbda x: tau => e[x], whats the the difference between x,y,z and =, => *)
and alternative =                      
...
and vAlternative =
  ...
  | VAltLet of Loc.t * vAlternative * vAlternative                              
...
and statement = 
  | ForAllExist of Loc.t * tpremise list * tpremise
  | Exist of Loc.t  * tpremise
