...
module Make_printer (Printing_state : Synext_pp_state.PRINTING_STATE) =
struct
...
module Printer = struct
  include Synext_pp_state.Printing_state
  include Make_printer (Synext_pp_state.Printing_state)
end
