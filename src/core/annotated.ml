...
module Comp = struct
  type exp_chk =
    ...
    | Case of Loc.t * case_pragma * exp_syn * branch list * Syntax.Int.Comp.tclo
   ...
   and exp_syn =
     | Var of Loc.t * offset * Syntax.Int.Comp.tclo
     | DataConst of Loc.t * cid_comp_const * Syntax.Int.Comp.tclo
     | DataDest of Loc.t * cid_comp_dest * Syntax.Int.Comp.tclo
     | Const of Loc.t * cid_prog * Syntax.Int.Comp.tclo
     ...
     | Ann of exp_chk * Syntax.Int.Comp.typ * Syntax.Int.Comp.tclo
