...
\begin{tabular}{ | l | l |}
\hline
\verb+```+ & Begin/end text block \\
\hline
\begin{tabular}{ l } \verb+# Level 1+ \\ \verb+## Level 2+ \\ \verb+### Level 3+ \\  \end{tabular} & Headers \\
\hline
\verb+*text*+ & Italicize text\\
\hline
\verb+**text**+ & Bold text\\
\hline
\verb+'code'+ & Inline code\\
\hline
\begin{tabular}{ l } 1. \\ 2. \\ 3 .\\ .. \\ \end{tabular} & Ordered list\\
\hline
\begin{tabular}{ l } - \\ - \\ - \\ .. \\ \end{tabular} & Unordered list\\
\hline
\verb+-----+ & Horizontal line\\
\hline
\verb+&rarr;+ & Right-arrow\\
\hline
\verb+&Gamma;+ & Upper-case gamma\\
\hline
\verb+&delta;+ & Lower-case delta\\
\hline
\verb+&forall;+ & Turned A\\
\hline
\verb+&exist;+ & Turned E\\
\hline
\end{tabular}
